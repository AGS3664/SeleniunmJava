...
public class Utility 
{
	...
	public static void AssertTrueOrFalse(boolean condition, String messageIfTrue, String messageIfFalse)
	{
		 ...
		 * { Select select = new Select(getElement(locator)); switch(type) { case
		 * "index": select.selectByIndex(Integer.parseInt(value)); break; case "value":
		 * select.selectByValue(value); break; case "visibletext":
		 * select.selectByVisibleText(value); break;
		 * 
		 * default: System.out.println("Please pass the correct selection criteria...");
		 * break; }
		 * 
		 * }
		 */
